...
function Spreadsheet() {
  ...
  useEffect(() => {
    const fetchSpreadsheet = async () => {
      ...
      try {
        const response = await fetch(`https://back-it.onrender.com/api/spreadsheet/${id}`, {
          method: 'GET',
          headers: {
    ...
    const connectWebSocket = () => {
      const wsClient = new WebSocket(`wss://back-it.onrender.com?spreadsheetId=${id}&clientId=${clientId.current}`);
