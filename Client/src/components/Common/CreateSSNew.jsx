    ...
    return (
        <div className="">
            <button
                ...
                className=" font-medium bg-blue-700 text-white rounded py-1 px-3 hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
